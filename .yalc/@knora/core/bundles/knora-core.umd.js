(function (global, factory) {
    ...
    */
    ...
    var ResourceService = /** @class */ (function (_super) {
        ...
        ResourceService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function ResourceService_Factory() { return new ResourceService(core.ɵɵinject(http.HttpClient), core.ɵɵinject(KuiCoreConfigToken), core.ɵɵinject(IncomingService), core.ɵɵinject(OntologyCacheService)); }, token: ResourceService, providedIn: "root" });
        ResourceService = __decorate([
            core.Injectable({
                providedIn: 'root'
            }),
            __param(1, core.Inject(KuiCoreConfigToken)),
            __metadata("design:paramtypes", [http.HttpClient, Object, IncomingService,
                OntologyCacheService])
        ], ResourceService);
        ...
        GravsearchGenerationService.prototype.createGravsearchQuery = function (properties, mainResourceClassOption, offset) {
            ...
            var props = properties.map(function (propWithVal, index) {
                ...
                if (!propWithVal.property.isLinkProperty || propWithVal.valueLiteral.comparisonOperator.getClassName() === 'Exists') {
                    ...
                    propValue = propWithVal.valueLiteral.value.toSparql(exports.KnoraSchema.complex);
                }
                // generate statement
                ...
                if (!propWithVal.property.isLinkProperty && propWithVal.valueLiteral.comparisonOperator.getClassName() !== 'Exists') {
                    ...
                    if (propWithVal.valueLiteral.comparisonOperator.getClassName() === 'Like') {
                        ...
                        restriction = "FILTER(knora-api:toSimpleDate(" + propValue + ") " + propWithVal.valueLiteral.comparisonOperator.type + " " + propWithVal.valueLiteral.value.toSparql(exports.KnoraSchema.complex) + ")";
                    }
    ...
    var ListService = /** @class */ (function (_super) {
        ...
        ListService.prototype.getList = function (rootNodeIri) {
            ...
            return listJSONLD.pipe(operators.mergeMap(
            // this would return an Observable of a PromiseObservable -> combine them into one Observable
            this.processJSONLD));
        };
        /**
        ...
        ListService.prototype.getListNode = function (listNodeIri) {
            ...
            return listNodeJSONLD.pipe(operators.mergeMap(
            // this would return an Observable of a PromiseObservable -> combine them into one Observable
            this.processJSONLD));
        };
    ...
    var ListCacheService = /** @class */ (function () {
        ...
        ListCacheService.prototype.getList = function (rootNodeIri) {
            ...
            if (this.listCache[rootNodeIri] !== undefined) {
                ...
                return rxjs.of(this.listCache[rootNodeIri]);
            }
            else {
                // get list from Knora and cache it
                var listJSONLD = this._listService.getList(rootNodeIri);
                var listV2 = listJSONLD.pipe(operators.map(this.convertJSONLDToListNode));
                return listV2.pipe(operators.map(function (list) {
        ...
        ListCacheService.prototype.getListNode = function (listNodeIri) {
            ...
            if (this.listNodeIriToListNodeV2[listNodeIri] !== undefined) {
                ...
                return rxjs.of(this.listNodeIriToListNodeV2[listNodeIri]);
            }
            else {
                var listNode = this._listService.getListNode(listNodeIri);
                return listNode.pipe(operators.mergeMap(function (listNodeJSONLD) {
                    var hasRootNode = _this.hasRootNode(listNodeJSONLD);
                    if (hasRootNode !== undefined) {
                        // get the whole list
                        return _this.getList(hasRootNode).pipe(operators.map(function (completeList) {
                        ...
                        return _this.getList(listNodeIri).pipe(operators.map(function (completeList) {
                            // get list node from cache
                            return _this.listNodeIriToListNodeV2[listNodeIri];
                        }));
                    }
